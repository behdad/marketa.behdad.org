...
not requirements for completing the trail.
...
open the same **Reset EQ** and **Kill** menu provided by right-click. The visible
three-dot button beside the bands opens that menu directly on devices that do
not deliver SVG long-presses.
