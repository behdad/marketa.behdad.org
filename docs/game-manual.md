...
If a saved session exists, the choice screen previews the room where you
stopped. **Continue** restores it, including any hidden room left open, without
...
- **Cuddly-puddly:** play with Octi and investigate the soft furnishings.
...
1. Turn on La Maz and let it warm up.
2. Run El Maz.
3. Tamp the grounds.
...
<details>
<summary><strong>Garden/party solution</strong></summary>

1. Water any plant with a bottle or the shelf mister.
...
<details>
<summary><strong>Cuddly-puddly solution</strong></summary>
...
<details>
<summary><strong>Office solution</strong></summary>

1. Use the laptop to call Prague.
2. Let the call connect, then hang up.
3. Boot and interact with the main monitor.
4. Leave the monitor zoom.
5. Turn off the room lamp and pendant light.
6. Select the stained-glass butterfly.
...
- **The Lofts** entrance pairs with the Balcony. Select the windows and street
  ...
  are independent controls. Click its lower half—or press Enter—to reveal its tan
...
On a touch phone or tablet, press or drag the left-side **D-pad** to move; drag the game
to aim and tap it to fire. Fullscreen leaves the D-pad in the side rail.
