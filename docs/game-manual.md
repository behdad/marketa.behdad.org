...
shows the current rendered FPS. Close it with backtick or its open/close button;
`Escape` and `Backspace` leave it open. Double-clicking the mask does not start
or stop the party.
...
and a projector. The wall screen cycles through fireplace, night-sky piano,
workout, aquarium, Totoro, and off. It can temporarily take ownership of the
...
active party and gathers Chinnell, Rafi, Markéta, and Behdad in Cuddly-puddly.
Tap Chinnell or Rafi there for an affectionate couch reaction, or slide either
...
edge to change its height for this visit. Its scrollback survives reloads until
the game is reset.
...
Python includes Turtle drawings and a FontTools SVG example.
