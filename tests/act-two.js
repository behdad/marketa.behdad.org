...
var HARNESS = [
  ...
  'window.__resetActTwo();window.__setDayNight(false);window.__goToStage("kitchen");window.__armActTwo(false);',
  ...
  'hidden=true;document.dispatchEvent(new Event("visibilitychange"));window.__goToStage("balcony");await sleep(4300);report.steps.hiddenArrival={beat:window.__actBeat(),caption:window.__captionKey(),scheduler:window.__attentionScheduleState()};hidden=false;document.dispatchEvent(new Event("visibilitychange"));window.dispatchEvent(new Event("focus"));await sleep(4200);report.steps.hiddenArrivalResumed={beat:window.__actBeat(),caption:window.__captionKey()};window.__resetActTwo();',
  'window.__goToStage("balcony");',
  'window.__resetActTwo();window.__armActTwo(true);',
  'var partySwitch=document.getElementById("balcony-partyswitch");',
  'report.steps.before={beat:window.__actBeat(),caption:window.__captionKey(),room:window.__currentStageName,pulse:partySwitch.classList.contains("invite-pulse")};',
  'window.__openEntranceRoom();window.__closeEntranceRoom();report.steps.lowerReturn={beat:window.__actBeat(),caption:window.__captionKey(),room:window.__currentStageName};',
  'window.__goToStage("kitchen");for(var i=0;i<120;i++)window.__actTwoTick();',
  ...
  'window.__goToStage("balcony");',
  'report.steps.returned={beat:window.__actBeat(),caption:window.__captionKey(),room:window.__currentStageName,pulse:partySwitch.classList.contains("invite-pulse")};',
  ...
  'report.steps.immediate={beat:window.__actBeat(),caption:window.__captionKey(),room:window.__currentStageName,party:!!window.__gardenPartyOn};',
  'await sleep(250);',
  'report.steps.held={beat:window.__actBeat(),caption:window.__captionKey(),room:window.__currentStageName};',
