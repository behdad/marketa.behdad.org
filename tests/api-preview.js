...
var HARNESS = [
  ...
  ' var before={room:window.__currentStageName,album:window.__albumList().length,messages:window.loft.api.query("messages.summary").value.total};',
