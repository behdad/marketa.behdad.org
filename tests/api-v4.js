...
check(["caption.show","cuddly.chest.status","cuddly.chest.set","car.status","car.control.set","roadtrip.status","roadtrip.preview.show","camping.fire.place","camping.stew.select","camping.stargazing.trace","camping.finale.advance","session.preview.begin","session.preview.end","trailer.status","trailer.play","trailer.stop","game.reset"].every(function (id) { return ids.includes(id); }), "room-owned controls, caption, trailer, terminal act, and preview lifecycle are typed", ids.length);
