...
var HARNESS = [
  ...
  ' S("api",{caps:caps,groups:groups,rooms:rooms,game:game,manifest:manifest,schemas:schemas,strict:strict,env:env,aliases:{bar:window.loft.bar===window.loft.kitchen,party:window.loft.party===window.loft.garden,roomBar:barRoom,roomParty:partyRoom,navBar:navBar,navParty:navParty},namespace:{partyImmediate:partyImmediate,pans:pans,chest:typeof window.loft.cuddly.chest.set,oldChest:typeof window.chest,oldPirate:typeof window.piratebox,oldStatus:typeof window.loftstatus},invalid:{auto:invalidAuto,gear:invalidGear},help:help,consoleHelp:consoleHelpText});',
