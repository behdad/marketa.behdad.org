...
var HARNESS = [
  ...
  'async function probe(stage,open,close){window.goToStage(stage);var opened=window[open]&&window[open]();await sleep(30);var row={opened:opened,covered:window.__roomAmbienceCovered(),allowed:allowed(stage)};if(window[close])window[close]();await sleep(850);row.restored=allowed(stage);return row;}',
  ...
  'window.__clearBalconyEclipse();var explicitResult=window.eclipse();report.steps.explicit={result:explicitResult,entrance:window.__entranceRoomOpen,solar:document.getElementById("stage-balcony").classList.contains("solar-eclipse")};window.__clearBalconyEclipse();',
  ...
  'window.goToStage("balcony");focused=false;report.steps.unfocused=allowed("balcony");focused=true;report.steps.refocused=allowed("balcony");var hidden=false;Object.defineProperty(document,"hidden",{configurable:true,get:function(){return hidden;}});Object.defineProperty(document,"visibilityState",{configurable:true,get:function(){return hidden?"hidden":"visible";}});hidden=true;report.steps.hidden=allowed("balcony");hidden=false;',
