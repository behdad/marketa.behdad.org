...
var HARNESS = [
  ...
  'function dblclick(el){clicks(el,2);el.dispatchEvent(new MouseEvent("dblclick",{bubbles:true,cancelable:true}));}',
  ...
  'var preGame=window.__balconyTetrisState().windows.slice(),preCaption=window.__captionKey&&window.__captionKey();dblclick(apartments[11]);await sleep(30);',
...
if (!r) fail("harness reported");
  ...
  var checks = {
    ...
    same_window_launch: "double-clicking a window launches the game",
