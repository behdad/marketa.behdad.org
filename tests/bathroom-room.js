...
var HARNESS = [
  ...
  ' var vanityTop=document.getElementById("bathroom-vanity-top"),vanityBottom=document.getElementById("bathroom-vanity-bottom"),vanitySinkHits=window.__bathroomInteractionState().hits.sink||0;click(vanityTop);var vanityTopOnly=window.__bathroomInteractionState();click(vanityBottom);var vanityBoth=window.__bathroomInteractionState();click(vanityTop);var vanityBottomOnly=window.__bathroomInteractionState();window.__resetBathroomProps();report.steps.vanity={topOnly:vanityTopOnly,both:vanityBoth,bottomOnly:vanityBottomOnly,reset:window.__bathroomInteractionState(),sinkHitsBefore:vanitySinkHits};',
...
var propNames = ["sink", "vanity-top", "vanity-bottom", "mirror", "toothbrushes", "comb", "soap", "tub-fill", "towel", "tub-drain", "stool", "cabinet", "scale", "toilet", "paper", "book", "spare-paper", "espresso"];
...
check(s.vanity && s.vanity.topOnly.active.indexOf("vanity-top-open") !== -1 &&
  s.vanity.topOnly.active.indexOf("vanity-bottom-open") === -1 &&
  ["vanity-top-open", "vanity-bottom-open"].every(function (name) { return s.vanity.both.active.indexOf(name) !== -1; }) &&
  s.vanity.bottomOnly.active.indexOf("vanity-top-open") === -1 &&
  s.vanity.bottomOnly.active.indexOf("vanity-bottom-open") !== -1 &&
  s.vanity.reset.active.indexOf("vanity-top-open") === -1 &&
  s.vanity.reset.active.indexOf("vanity-bottom-open") === -1 &&
  (s.vanity.bottomOnly.hits.sink || 0) === s.vanity.sinkHitsBefore,
  "both vanity drawers toggle independently without running the faucet and reset closed", s.vanity);
