...
var HARNESS = [
  ...
  ' var room=document.getElementById("bedroom-room"),viewport=document.querySelector(".hunt-viewport"),strip=document.getElementById("loft-game-strip"),office=document.getElementById("stage-office");room.style.transition="none";strip.style.transition="none";window.goToStage("office");window.__setDayNight(false);await sleep(100);',
  ' key("ArrowDown");await sleep(100);var roster=document.querySelector(".roster-panel"),rosterToggle=document.querySelector(".roster-toggle"),rosterBackdrop=document.querySelector(".roster-backdrop");roster.classList.add("show");rosterBackdrop.classList.add("show");',
