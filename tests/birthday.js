...
var HARNESS = [
  ...
  "  async function waitFor(test){var end=Date.now()+1500;while(Date.now()<end){if(test())return true;await sleep(25);}return false;}",
  ...
  "    window.__loftControllers.birthday('elisabeth'); await waitFor(function(){return window.__bdCakeOn&&document.querySelector('#garden-guests .g-elisabeth.bd-cutter');});",
  ...
  "    if (window.__endBdCakeCutting) window.__endBdCakeCutting(); await waitFor(function(){return !window.__bdCakeOn;});",
  "    // Adults with floor models use the same structural rule, even if they also have a family call.",
  "    window.__loftControllers.birthday('madla'); await waitFor(function(){return window.__bdCakeOn&&document.querySelector('#garden-guests .g-madla.bd-cutter');});",
  ...
  "    if (window.__endBdCakeCutting) window.__endBdCakeCutting(); await waitFor(function(){return !window.__bdCakeOn;});",
  "    window.__loftControllers.birthday('patricia'); await waitFor(function(){return window.__bdCakeOn&&document.querySelector('#garden-guests .g-patricia.bd-cutter');});",
  ...
  "    window.__loftControllers.birthday('chinnell'); await waitFor(function(){return window.__bdCakeOn&&document.querySelector('#garden-guests .g-chinnell.bd-cutter');});",
  ...
  "    window.__loftControllers.birthday('navid'); await waitFor(function(){return window.__bdCakeOn&&document.querySelector('#garden-guests .g-navid.bd-cutter');});",
  ...
  "    window.__loftControllers.birthday('hannah'); await waitFor(function(){return window.__bdCakeOn&&document.querySelector('#garden-guests .g-hannah.bd-cutter');});",
