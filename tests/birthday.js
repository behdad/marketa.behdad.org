...
var HARNESS = [
  ...
  "    // console jump to Ali (holiday decor) — a garden stop: party lit + garden",
...
if (!r) { fail("harness reported (page error before load, or budget too small)"); }
  ...
  if (s.ali && s.ali.party && s.ali.room === "garden" && s.ali.hatVisible === "visible") pass("garden stop lights the party, pans to the garden, hat visible"); else fail("Ali garden reveal", JSON.stringify(s.ali));
