...
check(s.lockedCtxOpen&&!s.lockedCtxOpen.showing&&!s.lockedCtxOpen.locked&&!s.lockedCtxOpen.trip.active,"the locked context action unlocks without opening the padlock or starting a trip",s.lockedCtxOpen);
