...
var HARNESS = [
  ...
  "    window.__setLang('en');window.__openPhoneAppHere('calendar');await sleep(40);",
  ...
  "    if(window.__loftControllers.phone)window.__loftControllers.phone.set(false);await sleep(280);if(window.__goToStage)window.__goToStage('cuddly');",
  "    window.__setLang('en');history.replaceState(null,'',location.pathname+'?date=2031-02-03&keep=1');",
  ...
  "    S('dateOnlyReset',{now:ymd(window.__now()),live:live,date:du.searchParams.get('date'),keep:du.searchParams.get('keep'),hash:du.hash,room:window.__currentStageName,nav:shown(dateNav),reset:shown(reset)});",
  "    window.__setLang('cs');history.replaceState(null,'',location.pathname+'?date=2032-09-18&time=05:31&keep=1');",
  "    if(window.__calReapplyDateTime)window.__calReapplyDateTime();await sleep(30);",
  ...
  "    S('combinedReset',{now:ymd(window.__now()),live:live,date:cu.searchParams.get('date'),time:cu.searchParams.get('time'),keep:cu.searchParams.get('keep'),hash:cu.hash,room:window.__currentStageName,dateNav:shown(dateNav),timeNav:shown(document.getElementById('loft-timenav')),reset:shown(reset)});",
