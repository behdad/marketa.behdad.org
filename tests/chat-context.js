...
var HARNESS = [
  ...
  ' S("sources",{mail:mail,messages:messages,phrasebook:phrasebook,photos:photos,tattoos:tattoos,notes:notes,named:named,roster:roster,catalog:catalog,ordinaryApps:Object.keys(ordinary.apps),broadChars:JSON.stringify({message:"Who are all the guests and what apps are available?",history:[],language:"auto",context:broad}).length});',
