...
var HARNESS = [
  ...
  ' window.fetch=function(url,opts){var n=captured.length;captured.push({url:String(url),method:opts&&opts.method,headers:opts&&opts.headers,body:opts&&opts.body});return new Promise(function(resolve){releases.push(function(){var replies=[{text:"سلام، من اینجا هستم.",action:null},{text:"دنبال می‌کنم.",action:null},{text:"You are in the office.",action:null},{text:"Let’s go.",action:{id:"room.go",args:{room:"garden"}}},{text:"Puff!",action:{id:"fishu.speak",args:{}}}];resolve(new Response(JSON.stringify({reply:JSON.stringify(replies[n]||{text:"Done.",action:null})}),{status:200,headers:{"Content-Type":"application/json"}}));});});};',
