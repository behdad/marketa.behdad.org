...
var HARNESS = [
  ...
  ' S("opened",{chat:mon.classList.contains("show-chat"),greeting:log.textContent,inputDir:input.getAttribute("dir"),endpoint:window.__monitorChatEndpoint});',
  ...
  ' S("request",{url:captured&&captured.url,method:captured&&captured.method,message:payload&&payload.message,language:payload&&payload.language,context:payload&&payload.context,history:payload&&payload.history});',
