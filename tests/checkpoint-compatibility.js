...
var LEGACY_HARNESS = [
  ...
  ' window.bbq(true);var smoker=document.getElementById("balcony-smoker"),before=smoker.classList.contains("smoking");',
...
var PORTABLE_HARNESS = [
  ...
  'window.addEventListener("load",function(){setTimeout(function(){try{',
  ' window.__setKitchenCoffeeState({step:"off",rounds:0});window.bbq(true);',
