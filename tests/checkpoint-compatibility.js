...
var LEGACY_HARNESS = [
  ...
  ' window.__goToStage("balcony");window.__startBBQ("ui");window.__goToStage("office");var smoker=document.getElementById("balcony-smoker"),before=smoker.classList.contains("smoking");',
  ...
  ' document.getElementById("__report").textContent=JSON.stringify({before:before,room:window.__currentStageName,coffee:window.__captureKitchenCoffeeState(),smoking:smoker.classList.contains("smoking"),open:smoker.classList.contains("open"),lamp:document.getElementById("office-lamp").classList.contains("dimmed"),pendant:document.getElementById("office-pendant").classList.contains("dimmed"),scrim:document.getElementById("office-lamp-dim").style.opacity,migrated:persisted.systems&&persisted.systems.coffee,errors:window.__errs});',
...
var PORTABLE_HARNESS = [
  ...
  'window.addEventListener("load",function(){setTimeout(function(){try{',
  ' window.__setKitchenCoffeeState({step:"off",rounds:0});window.__goToStage("balcony");window.__startBBQ("ui");window.__goToStage("office");',
  ' var imported=window.__loftSessionImport(handoff(false)),smoker=document.getElementById("balcony-smoker");',
  ...
  ' var partyImported=window.__loftSessionImport(handoff(true));',
