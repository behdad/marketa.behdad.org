...
var HARNESS = [
  ...
  ' var chirp=playCricketChirp();report.steps.started={state:window.__cricketAmbienceState(),live:!!(chirp&&chirp.active),gain:chirp&&chirp.master.gain.value};',
  ...
  ' report.steps.continued={gate:!!document.getElementById("loft-recovery-gate"),room:window.currentStageName,state:window.__cricketAmbienceState(),covered:window.__roomAmbienceCovered()};',
  ' var resumed=playCricketChirp();report.steps.resumed={state:window.__cricketAmbienceState(),live:!!(resumed&&resumed.active)};',
