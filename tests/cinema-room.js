...
check(s.offExit && !s.offExit.state.open && !s.offExit.state.powered &&
  !s.offExit.cooling && !s.offExit.poweredClass && s.offExit.animation !== "cinema-projector-cooldown",
  "leaving an already-off cinema does not flash the projector lens", s.offExit);
