...
var HARNESS = [
  ...
  ' window.__goToStage("cuddly");if(window.__setDayNight)window.__setDayNight(false);window.__cuddlyProjector.set("coffee");document.querySelector(".hunt-viewport").style.transition="none";document.getElementById("cinema-room").style.transition="none";document.getElementById("loft-game-strip").style.transition="none";await sleep(520);',
  ...
  ' window.__setLang("cs");report.steps.cs={lang:document.documentElement.lang,title:document.getElementById("cinema-room-title").textContent};window.__setLang("en");',
  ...
  ' click(film);await sleep(40);window.__goToStage("office");await sleep(80);report.steps.navigate={state:window.__cinemaRoomState(),room:window.__currentStageName,frame:!!document.getElementById("cinema-player"),channel:window.__cuddlyProjector.channel()};',
  ' window.__goToStage("cuddly");window.__cuddlyProjector.set("fire");window.__playSongAt(0);await sleep(100);window.__openCinemaRoom();report.steps.remoteResume={state:window.__cinemaRoomState(),current:document.querySelectorAll(".cinema-film.remote-current").length};click(film);await sleep(40);click(document.getElementById("hunt-floor-btn"));await sleep(900);report.steps.fastClose={open:window.__cinemaRoomState().open,song:window.__phoneMusicPlaying(),hidden:document.getElementById("cinema-room").hidden,viewport:document.querySelector(".hunt-viewport").classList.contains("cinema-room-open"),roster:[getComputedStyle(rosterToggle).visibility,getComputedStyle(roster).visibility,getComputedStyle(rosterBackdrop).visibility]};',
  ...
  ' window.__goToStage("garden");await sleep(80);dblclick(document.getElementById("garden-window-pane-0"));await sleep(40);report.steps.gardenInteractive=window.__princeState();',
  ...
  ' window.__goToStage("office");var toggles=0,steps=[],oldToggle=window.__toggleDayNight,oldStep=window.__calStepTime;window.__toggleDayNight=function(){toggles++;};window.__calStepTime=function(n){steps.push(n);};key("ArrowDown");key("ArrowUp");key("d");key("ArrowUp",{shiftKey:true});key("ArrowDown",{shiftKey:true});window.__toggleDayNight=oldToggle;window.__calStepTime=oldStep;report.steps.verticalElsewhere={toggles:toggles,steps:steps,cinema:window.__cinemaRoomState(),prince:window.__princeState(),bathroom:window.__bathroomRoomState()};',
  ' window.__goToStage("kitchen");key("ArrowDown");await sleep(850);report.steps.kitchenDown=window.__bathroomRoomState();key("ArrowUp");await sleep(760);report.steps.kitchenUp=window.__bathroomRoomState();',
  ' window.__goToStage("cuddly");key("ArrowDown");await sleep(850);report.steps.cuddlyDown=window.__cinemaRoomState();key("ArrowUp");await sleep(760);report.steps.cuddlyUp=window.__cinemaRoomState();',
  ' window.__goToStage("garden");key("ArrowDown");await sleep(850);report.steps.gardenDown=window.__princeState();key("ArrowUp");await sleep(780);report.steps.gardenUp=window.__princeState();',
  ' window.__secondRound=true;window.__goToStage("cuddly");key("ArrowDown");await sleep(850);window.__deliverPhoneMessage("cue_mail");await sleep(80);var badge=document.querySelector(".msg-badge"),coach=document.querySelector(".msg-badge-coach"),thumb=document.querySelector(".msg-thumb");report.steps.cinemaMessageHold={held:window.__messageNotificationsHeld(),badge:!!badge&&badge.classList.contains("show"),coach:!!coach&&coach.classList.contains("show"),thumb:!!thumb&&thumb.classList.contains("show"),thread:window.__phoneMessageThread()};key("ArrowUp");await sleep(1600);thumb=document.querySelector(".msg-thumb");report.steps.cinemaMessageRelease={held:window.__messageNotificationsHeld(),badge:!!badge&&badge.classList.contains("show"),thumb:!!thumb&&thumb.classList.contains("show"),thread:window.__phoneMessageThread()};if(window.__hideMessageThumb)window.__hideMessageThumb(true);',
  ' window.__goToStage("garden");key("ArrowDown");await sleep(850);window.__deliverPhoneMessage("cue_calendar");await sleep(80);report.steps.princeMessageHold={held:window.__messageNotificationsHeld(),badge:!!badge&&badge.classList.contains("show"),coach:!!coach&&coach.classList.contains("show"),thumb:!!thumb&&thumb.classList.contains("show"),thread:window.__phoneMessageThread()};key("ArrowUp");await sleep(1600);thumb=document.querySelector(".msg-thumb");report.steps.princeMessageRelease={held:window.__messageNotificationsHeld(),badge:!!badge&&badge.classList.contains("show"),thumb:!!thumb&&thumb.classList.contains("show"),thread:window.__phoneMessageThread()};',
  ' window.__goToStage("cuddly");key("ArrowDown");await sleep(100);key("ArrowLeft");await sleep(780);report.steps.cinemaLeft={room:window.__currentStageName,source:window.__cinemaRoomState(),target:window.__princeState(),nav:window.__lowerRoomNavigationState(),focus:document.activeElement.classList.contains("hunt-viewport")};',
  ' key("ArrowRight");await sleep(100);key("ArrowRight");await sleep(1500);report.steps.queuedRight={room:window.__currentStageName,target:window.__bedroomRoomState(),nav:window.__lowerRoomNavigationState()};',
  ' key("ArrowLeft");await sleep(780);key("ArrowLeft");await sleep(780);',
  ' key("ArrowRight");await sleep(780);key("ArrowRight");await sleep(780);report.steps.cinemaRight={room:window.__currentStageName,source:window.__cinemaRoomState(),target:window.__bedroomRoomState(),nav:window.__lowerRoomNavigationState(),focus:document.activeElement.classList.contains("hunt-viewport")};',
  ' key("ArrowLeft");await sleep(780);key("ArrowLeft");await sleep(780);var cinemaDot=document.querySelectorAll(".hunt-dot")[0];cinemaDot.focus();click(cinemaDot);await sleep(780);report.steps.cinemaDot={room:window.__currentStageName,source:window.__cinemaRoomState(),target:window.__bathroomRoomState(),nav:window.__lowerRoomNavigationState(),focus:document.activeElement===cinemaDot};',
  ' key("ArrowRight");await sleep(780);key("ArrowLeft");await sleep(780);report.steps.princeLeft={room:window.__currentStageName,source:window.__princeState(),target:window.__bathroomRoomState(),focus:document.activeElement.classList.contains("hunt-viewport")};',
  ' key("ArrowRight");await sleep(780);key("ArrowRight");await sleep(780);report.steps.princeRight={room:window.__currentStageName,source:window.__princeState(),target:window.__cinemaRoomState(),focus:document.activeElement.classList.contains("hunt-viewport")};',
  ' var princeDot=document.querySelectorAll(".hunt-dot")[4];princeDot.focus();click(princeDot);await sleep(780);report.steps.princeDot={room:window.__currentStageName,source:window.__princeState(),target:window.__entranceRoomState(),focus:document.activeElement===princeDot};',
...
check(s.props && s.props.sofaLeftOnly && s.props.sofaRightOnly &&
  s.props.sofaLeftOnly[0] && !s.props.sofaLeftOnly[1] &&
  s.props.sofaLeftOnly[2] && !s.props.sofaLeftOnly[3] &&
  !s.props.sofaRightOnly[0] && s.props.sofaRightOnly[1] &&
  s.props.sofaRightOnly[2] === s.props.sofaLeftOnly[2] && s.props.sofaRightOnly[3],
  "each Cinema leather cushion reacts and shifts independently", s.props && {
    left: s.props.sofaLeftOnly, right: s.props.sofaRightOnly
  });
...
check(s.sprinklerShort && s.sprinklerShort.state.shorted && !s.sprinklerShort.state.playing &&
  ...
  s.sprinklerShort.screenText === "" && s.sprinklerShort.screenKey === null &&
