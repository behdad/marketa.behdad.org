...
check(s.vimeoControls && s.vimeoControls.ready &&
  ...
  s.vimeoControls.commands.some(function(command){return command.method === "setVolume" && command.value !== s.vimeoControls.oldVolume;}) &&
  s.vimeoControls.commands.some(function(command){return command.method === "setVolume" && command.value === s.vimeoControls.oldVolume;}) &&
