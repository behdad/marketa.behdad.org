...
check("starting Day at the Loft reveals both date and time HUD controls",s.hud_shown_during_lapse===true);
check("stopping Day at the Loft restores normal hidden HUD visibility",s.hud_hidden_after_lapse===true);
