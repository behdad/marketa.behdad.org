...
var HARNESS = [
  ...
  'function showCode(){var mon=document.getElementById("office-monitor");["show-console","show-python","show-linux","show-caps"].forEach(function(cls){mon.classList.remove(cls);});mon.classList.add("screen-on","show-code");window.currentStageName="office";return mon;}',
  ...
  ' window.repeat("loop.js");window.__lastCodeErrors.js="js failure";window.__lastCodeErrors.python="python failure";window.__lastCodeError="js failure";',
  ...
  ' setLang("cs");ctxAt(row("trailer.js","builtin"));var csLabels=menuLabels();answers.push(false);one().click();var csPrompt=prompts[prompts.length-1];setLang("en");',
