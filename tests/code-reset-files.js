...
var HARNESS = [
  ...
  ' if(!phase){',
  '  localStorage.setItem("deskScripts",JSON.stringify({"mine.js":"window.mine=true;","loop.js":"await sleep(10000);"}));',
  ...
  ' window.repeat("loop.js");window.__lastCodeErrors.js="js failure";window.__lastCodeErrors.python="python failure";window.__lastCodeError="js failure";status.textContent="script failed — fix can help";panel.classList.add("open");panel.textContent="pending review";',
  ...
  ' setLang("cs");ctxAt(list);var csLabel=resetItem()&&resetItem().textContent;answers.push(false);resetItem().click();var csPrompt=prompts[prompts.length-1];setLang("en");',
