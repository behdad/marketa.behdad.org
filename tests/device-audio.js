...
var HARNESS = [
  ...
  ' window.goToStage("office");await sleep(920);var pc=document.getElementById("office-pc-desk-trio"),mon=document.getElementById("office-monitor"),laptop=document.getElementById("office-laptop"),oldPartyApply=window.__applyPartyMusicVolume,lastPartyFade=null;window.__applyPartyMusicVolume=function(fade){lastPartyFade=fade;return oldPartyApply&&oldPartyApply(fade);};click(pc);await sleep(80);var deskBeds=window.__activeAudioBedCount(),songVolume=window.__songVolume();mon.classList.add("screen-on");window.__monitorZoomIn();await sleep(420);report.steps.monitor={covered:window.__roomAmbienceCovered(),before:deskBeds,during:window.__activeAudioBedCount(),duck:window.__partyDuck,songVolume:window.__songVolume(),songBefore:songVolume,fade:lastPartyFade};',
