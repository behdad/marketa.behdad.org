...
var HARNESS = [
  ...
  "    window.goToStage('garden');await sleep(300);var partyBefore=!!(window.party&&window.party());enter();await sleep(3400);var pac=window.__pacmanPresentation&&window.__pacmanPresentation();report.phaseTwoActions.partyToggled=partyBefore&&!window.party()&&!!(pac&&!pac.mode);",
