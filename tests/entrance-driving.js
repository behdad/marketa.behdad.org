...
var HARNESS = [
  ...
  'key("keydown","Shift");key("keydown","1");key("keyup","Shift");key("keydown","ArrowUp");step(18);key("keyup","ArrowUp");var lowBefore=state();key("keydown","ArrowDown");step(3);key("keyup","ArrowDown");report.steps.lowBrake={before:lowBefore,after:state()};report.steps.brakeAudio={low:window.__entranceDriveBrakeAudio(40),hard:window.__entranceDriveBrakeAudio(180)};',
