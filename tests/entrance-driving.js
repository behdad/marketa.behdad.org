...
var HARNESS = [
  ...
  'Object.defineProperty(document,"hasFocus",{value:function(){return true;},configurable:true});window.__unlockAllRooms();document.getElementById("hunt-fullscreen-area").dispatchEvent(new MouseEvent("click",{bubbles:true,cancelable:true}));window.__goToStage("balcony");window.__openEntranceRoom();window.__entranceDriveTransmissionMode("manual",false);await sleep(30);',
