...
check(s.gloveboxOpen && s.gloveboxOpen.state.open && s.gloveboxOpen.state.drive.hud &&
  ...
  s.gloveboxOpen.doorTransform !== "none" &&
  JSON.stringify(s.gloveboxOpen.items) === JSON.stringify(["pink-cap","blue-cap","black-tube","black-tube"]),
