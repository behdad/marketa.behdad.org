...
var HARNESS = [
  ...
  'window.__unlockAllRooms();window.goToStage("balcony");window.__openEntranceRoom();window.__openEntrancePorscheDriveHud();window.__toggleEntrancePorscheEngine();report.street=snap();report.started=window.__entranceRoadtripStart();report.highway=snap();report.exited=window.__exitEntranceRoadtrip();report.returned=snap();',
