...
check(/function roadtripExplorationComplete\(\)[\s\S]{0,140}window\.__seenRooms\(\)\.length >= 10/.test(source) &&
  ...
  "ten seen rooms own authorization while street laps cannot bypass it");
