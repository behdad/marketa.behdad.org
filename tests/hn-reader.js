...
var HARNESS = [
  ...
  'async function run(){',
  ' window.phone("hn");await sleep(180);',
  ...
  ' window.__closePhoneModal(true);await sleep(260);window.phone("hn");await sleep(80);S("resume",{detail:document.querySelector(".pm-hn").getAttribute("data-story-id"),topCalls:topCalls});',
  ...
  ' window.__closePhoneModal(true);await sleep(260);window.__resetPhoneApps();window.phone("hn");await sleep(160);S("reset",{detail:document.querySelector(".pm-hn").getAttribute("data-story-id"),rows:document.querySelectorAll(".pmh-item").length,topCalls:topCalls});',
  '}',
  '})();</script>'
].join("\n");
