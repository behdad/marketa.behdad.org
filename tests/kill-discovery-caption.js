...
fails += check("Czech monitor focus localizes the desktop guidance", desktop && desktop.steps.czech && desktop.steps.czech.caption === "Pravým kliknutím ukončíš spuštěnou aplikaci. Každý umíráme jinak.", desktop && desktop.steps.czech);
...
fails += check("coarse primary input uses the press-and-hold guidance", touch && touch.steps.desktop && touch.steps.desktop.caption === "Press and hold a running app to Kill it. We all die differently." && touch.steps.czech && touch.steps.czech.caption === "Podržením ukončíš spuštěnou aplikaci. Každý umíráme jinak.", touch && { desktop: touch.steps.desktop, czech: touch.steps.czech });
