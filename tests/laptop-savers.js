...
var HARNESS = [
  ...
  ' var sequence=[];function pushSaver(){var state=window.__laptopSaverState();state.caption=saverCaption();sequence.push(state);}window.__startLaptopSaver();await sleep(60);pushSaver();window.__cycleLaptopSaver();await sleep(60);pushSaver();window.__cycleLaptopSaver();await sleep(60);pushSaver();S("sequence",sequence);',
...
check(r && r.steps.continued && r.steps.continued.open && r.steps.continued.show && !r.steps.continued.zoomed &&
  ...
  r.steps.continued.caption.key === "laptop_saver_caption_" + r.steps.continued.state.kind,
