...
var HARNESS = [
  ...
  '];',
  'async function visit(lang,out){window.__setLang(lang);for(var i=0;i<rooms.length;i++){var room=rooms[i];window.__goToStage(room[1]);await sleep(30);room[2]();await sleep(30);out[room[0]]=cap();room[3]();await sleep(760);}}',
  ...
  ' window.__setLang("en");window.__goToStage("office");window.__setCaption("office_call",true);window.__openBedroomRoom();await sleep(30);var bedroomAction=cap();window.__closeBedroomRoom();var officeReturn=cap();report.bedroomReturn={inside:bedroomAction,upstairs:officeReturn};',
  ' window.__setLang("en");window.__goToStage("garden");window.__setCaption("garden",true);window.__openGardenPrince();await sleep(500);document.getElementById("hunt-floor-btn").click();var dungeonUpImmediate=cap();await sleep(760);report.dungeonUp={immediate:dungeonUpImmediate,settled:cap()};',
  ' window.__setLang("en");window.__goToStage("kitchen");await sleep(20);var upstairs=cap();window.__captionOverlay("trip_caption_molly",{owner:"caption-test",scope:"stage:kitchen",priority:30,duration:550,clock:"wall"});var before=cap();window.__openBathroomRoom();var during=cap();await sleep(620);var restored=cap();var repeat=window.__openBathroomRoom();window.__captionOverlay("trip_caption_molly",{owner:"caption-close-test",scope:"lower:bathroom",priority:30,duration:550,clock:"wall"});window.__closeBathroomRoom();var closing=cap();await sleep(620);var upstairsRestored=cap();report.transient={upstairs:upstairs,before:before,during:during,restored:restored,repeat:repeat,closing:closing,upstairsRestored:upstairsRestored};',
  ' window.__setCaption("lower_dungeon",true);window.__captionOverlay("trip_caption_molly",{owner:"caption-rebase-test",scope:"stage:kitchen",priority:30,duration:550,clock:"wall"});var rebaseBefore=cap();window.__setCaption("cuddly",true);var rebaseDuring=cap();await sleep(620);var rebaseRestored=cap();report.rebased={before:rebaseBefore,during:rebaseDuring,restored:rebaseRestored};',
  ' window.__setSecondRound(true,{releaseHeld:false});window.__setGardenParty(true,false);window.__setSeenRooms(["kitchen","garden","cuddly","office","balcony","bathroom","dungeon","cinema","bedroom","entrance"]);window.__goToStage("balcony");window.__openEntranceRoom();await sleep(40);window.__setLang("en");var readyEn=cap();window.__setLang("cs");var readyCs=cap();var readyState=window.__entranceRoomState();report.entranceReady={en:readyEn,cs:readyCs,roadtrip:readyState.drive&&readyState.drive.roadtrip,party:!!window.__gardenPartyOn};',
...
var expected = {
  en: {
    ...
    dungeon: "Dungeon · two cold torches guard a sealed wall.",
  ...
  cs: {
    ...
    dungeon: "Kobka · zapečetěnou zeď střeží dvě vyhaslé pochodně.",
