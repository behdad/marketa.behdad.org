...
var HARNESS = [
  ...
  'function finishWalk(){document.getElementById("witchy-chest-cat-walk").getAnimations().forEach(function(a){try{var done=a.onfinish;a.finish();if(typeof done==="function")done.call(a);}catch(_e){}});}',
