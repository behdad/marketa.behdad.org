...
var r = lib.runPageSync("rsvp.html", HARNESS, 11000, { patchRaf: true, urlSuffix: "#play" });
if (!r) {
...
check(r.bedroom && r.bedroom.count === 1 && r.bedroom.parent === "bedroom-room-art" &&
  r.bedroom.visible && r.bedroom.napping && r.bedroom.walkTransform !== "none",
