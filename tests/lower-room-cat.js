...
var HARNESS = [
  ...
  'function finishWalk(){document.getElementById("witchy-chest-cat-walk").getAnimations().forEach(function(a){try{var done=a.onfinish;a.onfinish=null;a.finish();if(typeof done==="function")done.call(a);}catch(_e){}});}',
...
check(r.bedroomReaction && r.bedroomStartled && r.bedroomStartled.animations.indexOf(720) !== -1 &&
  ...
  { before: r.bedroom, reaction: r.bedroomReaction, startled: r.bedroomStartled, floor: r.bedroomFloor });
