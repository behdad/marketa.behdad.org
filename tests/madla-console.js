...
var HARNESS = [
  ...
  'async function run(){',
  ' window.goToStage("office");await wait(30);window.__secondRound=false;window.__gardenPartyOn=false;',
  ' report.steps.autoPhase1=window.__madlaRing();',
  ' var explicitPhase1=window.madla();await wait(30);report.steps.explicitPhase1={promise:!!(explicitPhase1&&typeof explicitPhase1.then==="function"),ring:!!document.querySelector(".call-ring.show")};',
  ' var answered=window.__answerMadla(true);await wait(80);report.steps.answer={answered:answered,room:window.currentStageName,phone:!!document.querySelector(".phone-backdrop.show"),call:window.__chatPhoneState&&window.__chatPhoneState().call};',
