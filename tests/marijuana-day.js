...
var HARNESS = [
  ...
  ' window.__jumpToDate(2027,3,20);window.garden.set(true);window.__openPhoneAppHere("calendar");await sleep(40);',
  ...
  ' var behdad=document.getElementById("cuddly-behdad");S("activate",{phone:!!document.querySelector(".phone-backdrop.show"),room:window.currentStageName,party:window.party.status(),smoking:behdad.classList.contains("smoking-joint"),status:window.__marijuanaDayStatus()});',
  ...
  ' window.__jumpToDate(2027,3,20);window.goToStage("office");var away=window.__marijuanaDayTick();window.goToStage("cuddly");var home=window.__marijuanaDayTick();',
