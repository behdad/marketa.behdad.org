...
var HARNESS = [
  ...
  'async function run(){',
  ' window.__secondRound=true;window.__deliverPhoneMessage("cue_mail");if(window.__hideMessageThumb)window.__hideMessageThumb();window.__deliverPhoneMessage("cue_calendar");if(window.__hideMessageThumb)window.__hideMessageThumb();window.__loftControllers.phone.open("messages");await sleep(100);S("first",coachState());',
  ...
  ' window.__setLang("cs");await sleep(80);S("czech",coachState());',
  ' window.__closePhoneModal(true);await sleep(260);window.__loftControllers.phone.open("messages");await sleep(100);S("reopen",coachState());',
  ...
  ' window.__closePhoneModal(true);await sleep(260);window.__resetPhoneApps();window.__checkpointPhoneRestore(saved);window.__loftControllers.phone.open("messages");await sleep(100);S("dismissedRestore",coachState());',
  ' window.__closePhoneModal(true);await sleep(260);window.__resetPhoneApps();window.__deliverPhoneMessage("cue_mail");if(window.__hideMessageThumb)window.__hideMessageThumb();window.__deliverPhoneMessage("cue_calendar");if(window.__hideMessageThumb)window.__hideMessageThumb();window.__loftControllers.phone.open("messages");await sleep(100);S("afterReset",coachState());',
  ' var action=document.querySelector(".pm-msg-act:not(.used)");if(action)action.click();await sleep(100);window.__loftControllers.phone.open("messages");await sleep(100);S("used",coachState());',
  '}',
  '})();</script>'
].join("\n");
