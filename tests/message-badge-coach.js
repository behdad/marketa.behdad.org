...
var HARNESS = [
  ...
  'async function run(){',
  ' finishGuide();document.getElementById("hunt-fullscreen-area").dispatchEvent(new MouseEvent("click",{bubbles:true,cancelable:true}));window.__secondRound=true;if(window.__stopCueDrip)window.__stopCueDrip();window.__deliverPhoneMessage("cue_mail");if(window.__hideMessageThumb)window.__hideMessageThumb();window.__repeatMsgBadgeCoach();await sleep(80);S("first",snap());',
