...
var HARNESS = [
  ...
  ' window.__runMsgAction("cue_mail");await sleep(30);if(window.phone)window.phone(false);await sleep(260);var badgeUse=badge.querySelector("use");S("read",{shown:badge.classList.contains("show"),idle:badge.classList.contains("idle"),icon:!!badgeUse&&badgeUse.getAttribute("href")==="#dicon-chat"});',
