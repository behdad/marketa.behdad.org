...
var harness = [
  ...
  'window.__setLang("en");window.__goToStage("balcony");window.__startBalconyTetris();',
  ...
  'window.__setLang("cs");out.csTetris={text:status.textContent,width:status.getComputedTextLength()};',
  'close.dispatchEvent(new MouseEvent("click",{bubbles:true,cancelable:true}));',
  'window.__goToStage("office");window.__arcadeTest(1,16);',
  ...
  'window.__setLang("en");window.__goToStage("kitchen");window.__flairTest(1,16);',
  ...
  'window.__goToStage("office");var mon=document.getElementById("office-monitor"),tower=document.getElementById("office-pc-desk-trio");',
