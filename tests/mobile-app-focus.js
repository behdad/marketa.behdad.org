...
var HARNESS = [
  ...
  ' window.__loftControllers.phone.set(false);await sleep(260);window.__goToStage("office");await sleep(80);var mon=document.getElementById("office-monitor"),tower=document.getElementById("office-pc-desk-trio");tower.classList.add("on");mon.classList.add("here","screen-on","show-caps");window.__monitorZoomIn();await sleep(40);',
