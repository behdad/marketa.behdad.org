...
function run(label, chromeFlags) {
  ...
  check(result.photoboothPicker && result.photoboothPicker.videoZ === "auto" &&
      result.photoboothPicker.pickerZ === "1" && result.photoboothPicker.controlsZ === "2" &&
      result.photoboothPicker.retakeCircle === "#d3822f" && result.photoboothPicker.retakePaths === 2,
    "Photobooth picker paints above its video while the clear retake control remains topmost", result.photoboothPicker);
