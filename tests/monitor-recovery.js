...
// and apps launched after Continue enter through their normal live paths.
"use strict";
...
var HARNESS = [
  ...
  '<script>(function(){',
  'var saved={version:1,savedAt:Date.now(),progress:{room:"office",maxUnlocked:4,phase2:true,party:false,daylight:true,bbq:false},puzzle:{},phone:null,album:null,systems:{pc:{powered:true},monitor:{surface:"monitor",screenOn:true,foreground:"video",running:["video","mail","doom","python","linux"],zoomed:true}}};',
...
check(continued && continued.room === "office" && continued.tower && continued.here &&
  continued.screen && continued.desktop && continued.zoomed,
