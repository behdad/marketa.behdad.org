...
check(s.touchOpen.state.open && !s.touchOpen.state.query && s.touchOpen.prompt === "search apps…" && s.touchOpen.focused && s.touchOpen.defaultKept && s.touchOpen.aria === "Search apps" && s.touchOpen.pointer === "auto" && s.touchOpen.inputBox[0] >= 32 && s.touchOpen.inputBox[1] >= 16, "an uncancelled menu-bar click opens search and focuses its native input", s.touchOpen);
