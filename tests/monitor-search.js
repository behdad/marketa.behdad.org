...
check(s.touchOpen.state.open && !s.touchOpen.state.query && s.touchOpen.prompt === "search apps…" && s.touchOpen.focused && s.touchOpen.aria === "Search apps" && s.touchOpen.pointer === "auto" && s.touchOpen.inputBox[0] >= 32 && s.touchOpen.inputBox[1] >= 16, "touch-down on the menu-bar magnifier opens search and focuses a measurable keyboard bridge", s.touchOpen);
