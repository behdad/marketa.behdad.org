...
check(s.touchOpen.state.open && !s.touchOpen.state.query && s.touchOpen.prompt === "search apps…" && s.touchOpen.focused && s.touchOpen.aria === "Search apps", "the menu-bar magnifier opens localized empty search and focuses the touch keyboard bridge", s.touchOpen);
