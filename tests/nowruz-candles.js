...
var HARNESS = [
  ...
  'function state(){var a=document.getElementById("office-hs-candle-1"),b=document.getElementById("office-hs-candle-2"),fa=a.querySelector(".sn-hs-flame"),fb=b.querySelector(".sn-hs-flame"),ga=a.querySelector(".sn-hs-glow"),gb=b.querySelector(".sn-hs-glow"),w=document.getElementById("witchy-chest-cat-walk");return {lit:window.__nowruzCandleState(),flame:[getComputedStyle(fa).opacity,getComputedStyle(fb).opacity],glow:[getComputedStyle(ga).opacity,getComputedStyle(gb).opacity],night:document.getElementById("stage-office").classList.contains("dusk"),cat:window.__loftControllers.cat.status(),fish:document.getElementById("office-hs-fish-dart").classList.contains("darting"),pounces:fishPounces(),roamPaused:w.style.animationPlayState==="paused"};}',
  ...
  'async function run(){',
  ' window.__loftControllers.season("nowruz");window.__goToStage("office");await sleep(40);S("initial",state());',
  ...
  ' window.__loftControllers.season("canada");click("office-hs-bowl-hit");await sleep(80);S("fishOffSeason",state());',
  ' window.__loftControllers.cat.set(false);await sleep(40);window.__loftControllers.season("nowruz");',
  ' window.__loftControllers.season("canada");click("office-hs-candle-1-hit");await sleep(40);S("seasonExit",state());',
  ' window.__loftControllers.season("nowruz");click("office-hs-candle-2-hit");await sleep(40);window.__activateExtinguisher();await sleep(1300);S("fullReset",state());',
  '}',
  '})();</script>'
].join("\n");
