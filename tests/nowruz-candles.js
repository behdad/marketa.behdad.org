...
// day/night continuity, neighboring fish behavior, and season/full-reset teardown.
"use strict";
...
var HARNESS = [
  ...
  'function state(){var a=document.getElementById("office-hs-candle-1"),b=document.getElementById("office-hs-candle-2"),fa=a.querySelector(".sn-hs-flame"),fb=b.querySelector(".sn-hs-flame"),ga=a.querySelector(".sn-hs-glow"),gb=b.querySelector(".sn-hs-glow");return {lit:window.__nowruzCandleState(),flame:[getComputedStyle(fa).opacity,getComputedStyle(fb).opacity],glow:[getComputedStyle(ga).opacity,getComputedStyle(gb).opacity],night:document.getElementById("stage-office").classList.contains("dusk"),cat:window.cat(),fish:document.getElementById("office-hs-fish-dart").classList.contains("darting")};}',
  ...
  ' click("office-hs-bowl-hit");await sleep(80);S("fish",state());',
...
check(s.fish && s.fish.fish && same(s.fish.lit, [true, false]),
  "the neighboring goldfish reaction remains independent", s.fish);
