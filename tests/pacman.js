...
var HARNESS = [
  ...
  'var spaceEvent=new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:true,cancelable:true});var spacePrevented=!document.dispatchEvent(spaceEvent),pausedNow=window.__pacmanState();await sleep(180);var pausedStill=window.__pacmanState();S("space_pauses",spacePrevented&&pausedNow.paused&&!pausedNow.running&&pausedStill.score===pausedNow.score&&typeof window.__pacmanTogglePause==="function");key(" ");await sleep(80);S("space_resumes",!window.__pacmanState().paused&&window.__pacmanState().running);',
