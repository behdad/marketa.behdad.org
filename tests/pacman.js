...
var HARNESS = [
  ...
  'wrap.querySelector(".pac-new").click();var fresh=window.__pacmanState();S("new_resets",fresh.status==="ready"&&fresh.score===0&&fresh.high===250&&fresh.lives===3&&fresh.remaining===143);wrap.querySelector(".pac-btn[data-dir=left]").click();S("pad_plays",window.__pacmanState().status==="running"&&window.__pacmanState().running);',
