...
var HARNESS = [
  ...
  'var unlockedSearchList=window.__openMonitorApp("__missing__"),unlockedApps=window.__chatMonitorApps();S("stays_hidden",!document.getElementById("monitor-dock-pacman")&&unlockedSearchList.indexOf("pacman")<0&&!unlockedApps.some(function(app){return app.id==="pacman";}));',
  ...
  'window.__resetPacmanUnlock(); S("full_reset_relocks",window.__pacmanUnlocked()===false&&!document.getElementById("monitor-dock-pacman")&&window.__pacmanState().running===false);',
  '}',
