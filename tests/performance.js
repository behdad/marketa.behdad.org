...
check(a.garden_hidden_parking.stable.running <= 180 && a.garden_hidden_parking.stable.hidden <= 2 && a.garden_hidden_parking.parking.held >= 20, "a stable full party leaves no persistently hidden garden animation workload", a.garden_hidden_parking);
