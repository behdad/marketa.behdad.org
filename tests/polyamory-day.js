...
var HARNESS = [
  ...
  ' window.__jumpToDate(2027,10,24);if(window.__loftControllers.party)window.loft.garden.set(false);window.__goToStage("cuddly");await sleep(80);',
  ...
  ' window.loft.garden.set(true);await sleep(80);S("party",{visibility:getComputedStyle(pair).visibility,on:document.getElementById("loft-game-strip").classList.contains("party-on")});window.loft.garden.set(false);',
