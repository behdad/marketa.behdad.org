...
var HARNESS = [
  ...
  ' var chBal=document.getElementById("bh-chinnell"),raBal=document.getElementById("bh-rafi"),adultBal=document.getElementById("bh-patricia-son"),chBox=chBal.getBBox(),raBox=raBal.getBBox(),adultBox=adultBal.getBBox();',
