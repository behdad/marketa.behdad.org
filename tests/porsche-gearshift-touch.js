...
var HARNESS = [
  ...
  'Object.defineProperty(document,"hasFocus",{value:function(){return true;},configurable:true});window.__unlockAllRooms();window.goToStage("balcony");window.__openEntranceRoom();window.__openEntrancePorscheDriveHud();window.__entranceDriveTransmissionMode("manual",false);window.__toggleEntrancePorscheEngine();await sleep(80);',
