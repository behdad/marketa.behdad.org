...
// valid Pride tap gets the emphatic flutter + room wash, and season transitions reset it.
"use strict";
...
var HARNESS = [
  ...
  'function state(){var c=document.getElementById("office-pride-flag-wave"),w=document.getElementById("office-pride-wash");return {wave:c.classList.contains("waving"),celebrate:c.classList.contains("pride-celebrating"),wash:w.classList.contains("pride-celebrating"),flagAnimation:getComputedStyle(c).animationName,washAnimation:getComputedStyle(w).animationName};}',
  ...
  'async function run(){',
  ' window.__setSeason("pride");click();await sleep(80);S("first",state());',
  ' click();await sleep(80);S("second",state());',
  ' click();await sleep(80);S("third",state());',
  ' await sleep(2150);S("settled",state());',
  ' window.__setSeason("pride");click();click();await sleep(80);window.__setSeason("canada");window.__setSeason("pride");click();await sleep(80);S("seasonReset",state());',
  ' click();click();await sleep(80);window.__activateExtinguisher();await sleep(1300);window.__setSeason("pride");click();await sleep(80);S("fullReset",state());',
...
check(s.third && !s.third.wave && s.third.celebrate && s.third.wash &&
      s.third.flagAnimation === "office-pride-flag-celebrate" && s.third.washAnimation === "office-pride-wash",
  "third tap runs the emphatic flutter and office wash", s.third);
