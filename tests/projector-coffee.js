...
var HARNESS = [
  ...
  ' window.__goToStage("cuddly");window.__cuddlyProjector.set("coffee");await sleep(520);',
  ...
  ' window.__setLang("cs");report.steps.cs={label:window.__nowPlayingLabel(),toast:(document.querySelector(".np-toast")||{}).textContent};window.__setLang("en");',
