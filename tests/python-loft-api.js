...
async function main() {
  ...
  var manifest = [
    ...
    { id: "trailer.play", kind: "action", completion: "finite", description: "play trailer", args: {} }
  ];
  var api = {
  ...
  var python = [
    ...
    "import loft",
    "",
    "loft_help = builtins.help",
    "assert loft_help is not original_help",
    "loft = importlib.reload(loft)",
    "assert builtins.help is loft_help",
    ...
    "def rendered_python_help(target):",
    "    output = io.StringIO()",
    "    with contextlib.redirect_stdout(output):",
    "        result = builtins.help(target)",
    "    assert result is None",
    "    return output.getvalue().rstrip('\\n')",
    "assert rendered_python_help(loft) == 'JS HELP ROOT'",
    "assert rendered_python_help(loft.trailer) == 'JS HELP trailer'",
    "assert rendered_python_help(loft.room.go) == 'JS HELP room.go'",
