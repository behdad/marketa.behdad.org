...
var HARNESS = [
  ...
  'var qs=window.__quizQuestions&&window.__quizQuestions();',
  'var ids={};(qs||[]).forEach(function(q){q.a.forEach(function(a){a.who.forEach(function(w){ids[w]=1;});});});',
  'document.getElementById("__report").textContent=JSON.stringify({errors:window.__errs,questions:qs,ids:Object.keys(ids)});',
  '},250);});})();</script>'
].join("\n");
