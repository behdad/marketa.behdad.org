...
var HARNESS = [
  ...
  ' document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:true,cancelable:true}));document.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",repeat:true,bubbles:true,cancelable:true}));document.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:true,cancelable:true}));S("continued",{gate:!!document.getElementById("loft-recovery-gate"),room:window.currentStageName,max:window.__maxUnlocked(),phase2:!!window.__secondRound,started:window.__gameStarted(),spaceLeaks:leakedSpace,spaceHeld:!!window.__recoveryActivationHeld,caption:caption&&caption.textContent,recoveryCaption:caption&&caption.classList.contains("recovery-caption"),recoveryActive:area&&area.classList.contains("recovery-active"),leftVisibility:getComputedStyle(document.getElementById("hunt-left")).visibility,rightVisibility:getComputedStyle(document.getElementById("hunt-right")).visibility,dotsDisplay:getComputedStyle(document.getElementById("hunt-dots")).display,watchParent:watch&&watch.parentNode&&watch.parentNode.tagName,watchHidden:watch.hidden,watchAria:watch.hasAttribute("aria-hidden"),watchDisplay:getComputedStyle(watch).display,frontDoor:document.getElementById("balcony-door").classList.contains("open"),nookDoor:document.getElementById("cuddly-balcony-door").classList.contains("open")});',
