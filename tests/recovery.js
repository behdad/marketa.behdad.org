...
check(s.continued.partyRestored && s.continued.switchRestored &&
  s.continued.partyAfterP && s.continued.switchAfterP,
  "a restored party keeps its switch synchronized", s.continued);
