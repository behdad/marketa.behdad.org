...
check(s.gate.recoveryActive && s.gate.restartVisibility === "hidden" && s.gate.leftVisibility === "hidden" && s.gate.rightVisibility === "hidden" && s.gate.dotsDisplay === "none" && s.gate.fullscreenVisibility === "visible", "recovery hides inactive navigation but keeps fullscreen available", s.gate);
