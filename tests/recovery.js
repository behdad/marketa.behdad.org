...
check(startedOver && startedOver.translatedClickMe && startedOver.translatedClickMe.brand === "Den v loftu" &&
  startedOver.translatedClickMe.word === "KLIKNI!" && startedOver.translatedClickMe.promise === "Zkoumej → Párty → Výlet" &&
  startedOver.translatedClickMe.ariaCount === 0,
...
check(startedOver && Math.abs(startedOver.clickBrandTopRatio - s.gate.brandTopRatio) < .002,
  "CLICK ME and recovery place Loft Day at the same height", startedOver && startedOver.clickBrandTopRatio);
