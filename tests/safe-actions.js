...
var HARNESS = [
  ...
  'window.__loftControllers.firstdance=function(){calls.push("first-dance");return true;};',
  ...
  'window.__arcadeState=function(){return {active:false};};window.__flairState=function(){return {active:false};};var ambientMaking=false;window.__ambientMaking=function(){return ambientMaking;};window.__userMixing=function(){return false;};window.__bartenderDragging=function(){return false;};window.__makeCocktail=function(name,night){ambientMaking=true;setTimeout(function(){ambientMaking=false;},30);calls.push("cocktail:"+name+":"+night);return "ordered";};window.__loftControllers.mixer=function(name){calls.push("mixer:"+name);return Promise.resolve({completed:true});};',
  ...
  'window.__goToStage=function(room){window.__currentStageName=room;calls.push("room:"+room);};window.__startArcade=function(){calls.push("invaders");};window.__startFlairCatch=function(){calls.push("flair-catch");};window.__barUpNow=function(){return true;};',
  ...
  'window.__loftControllers.chase=function(){calls.push("kids-chase");return Promise.resolve({completed:true});};window.__loftControllers.butterfly=function(){calls.push("butterfly");return Promise.resolve({completed:true});};window.__loftControllers.rainbow=function(){calls.push("rainbow");return Promise.resolve({completed:true});};',
