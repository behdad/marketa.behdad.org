...
var PROBE_HARNESS = [
  ...
  "    ok('opening guide: Enter dismisses the clue coach without operating Kitchen', !(window.__openingGuideShowing && window.__openingGuideShowing()) && !introMachine.classList.contains('powered-on') && has('kitchen-lamarzocco', 'invite-pulse'));",
  "    if (window.__showHuntIntro) window.__showHuntIntro();",
  "    introOverlay = el('click-me-overlay'); if (introOverlay) introOverlay.dispatchEvent(new MouseEvent('click', { bubbles: true, cancelable: true }));",
