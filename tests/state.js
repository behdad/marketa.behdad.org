...
var PROBE_HARNESS = [
  ...
  "    document.dispatchEvent(new KeyboardEvent('keydown', { key: '`', code: 'Backquote', bubbles: true, cancelable: true }));",
  "    var mask = el('garden-mask'), partyBeforeMask = !!(window.party && window.party.status());",
  ...
  "      if (mask) mask.dispatchEvent(new MouseEvent('click', { bubbles: true }));",
  "      if (mask) mask.dispatchEvent(new MouseEvent('click', { bubbles: true }));",
  "      ok('garden mask: two rapid clicks no longer toggle the party', !!mask && !!(window.party && window.party.status()) === partyBeforeMask && !(window.__dropTermOpen && window.__dropTermOpen()));",
  "      if (mask) mask.dispatchEvent(new MouseEvent('click', { bubbles: true }));",
