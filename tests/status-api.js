...
var HARNESS = [
  ...
  ' var calls=[];window.rain={status:function(){return !!window.__wxRain;},set:function(on){window.__wxRain=!!on;calls.push("rain:"+on);return !!window.__wxRain;}};window.storm={status:function(){return !!window.__wxStorm;},set:function(on){window.__wxStorm=!!on;calls.push("storm:"+on);return !!window.__wxStorm;}};window.overcast={status:function(){return !!window.__wxOvercast;},set:function(on){window.__wxOvercast=!!on;calls.push("overcast:"+on);return !!window.__wxOvercast;}};',
  ...
  ' var auroraOn=false,twilightOn=false;window.aurora={status:function(){return auroraOn;},set:function(on){auroraOn=!!on;calls.push("aurora:"+on);return auroraOn;}};window.twilight={status:function(){return twilightOn;},set:function(on){twilightOn=!!on;calls.push("twilight:"+on);return twilightOn;}};window.__auroraStatus=function(){return {showing:auroraOn,kp:7};};window.__setTwilight=function(){return twilightOn;};',
