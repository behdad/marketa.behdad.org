...
check(q.rooms.ok && q.rooms.value.length === 5 && q.rooms.value[3].current && q.rooms.value[3].unlocked && !q.rooms.value[3].solved && !q.rooms.value[4].unlocked, "room.list keeps unlocked and solved state independent", q.rooms);
