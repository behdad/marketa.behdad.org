...
var HARNESS = [
  ...
  "  S('about_killing',about.classList.contains('killing')&&about.textContent.indexOf('about:eternity')>=0&&about.textContent.indexOf('about:blank')<0&&aboutRings.length===4&&!!about.querySelector('.monitor-about-portal-core')&&document.getElementById('hunt-caption').textContent==='Have you tried turning reality off and on again?'&&window.__loftMessages.cs.hunt.df_about_quip==='Zkoušeli jste realitu vypnout a znovu zapnout?');",
