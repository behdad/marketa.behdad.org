...
var HARNESS = [
  ...
  'function classes(){var s=document.getElementById("loft-game-strip");return ["shrooms","acid","froggies","dmt","molly","ketamine","iboga"].filter(function(x){return s.classList.contains(x);});}',
...
var result = lib.runPageSync("rsvp.html", HARNESS, 5200, { patchRaf: true });
