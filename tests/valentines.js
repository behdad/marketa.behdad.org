...
var HARNESS = [
  ...
  ' document.hasFocus=function(){return true;};window.__gameStarted=function(){return true;};party(false);window.goToStage("cuddly");',
  ...
  ' window.goToStage("cuddly");party(true);await sleep(80);S("party",{couple:couple.classList.contains("at-party"),visibility:getComputedStyle(couple).visibility});party(false);',
