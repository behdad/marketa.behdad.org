...
var HARNESS = [
  ...
  ' report.steps.butterfly={track:window.__monitorVideoTrack(),src:video.src,time:fakeTime,playing:window.__videoPlaying(),playCalls:playCalls,pauseCalls:pauseCalls,downtownPressed:downtown.getAttribute("aria-pressed"),rosePressed:rose.getAttribute("aria-pressed"),butterflyPressed:butterfly.getAttribute("aria-pressed")};',
  ...
  ' report.steps.reset={open:monitor.classList.contains("show-video"),track:window.__monitorVideoTrack(),src:video.src,time:fakeTime,downtownPressed:downtown.getAttribute("aria-pressed"),rosePressed:rose.getAttribute("aria-pressed"),butterflyPressed:butterfly.getAttribute("aria-pressed")};',
...
check(s.butterfly && s.butterfly.track === "butterfly" && /art\/rainbow-butterfly\.mp4$/.test(s.butterfly.src) &&
  ...
  s.butterfly.downtownPressed === "false" && s.butterfly.rosePressed === "false" &&
  s.butterfly.butterflyPressed === "true",
...
check(s.reset && !s.reset.open && s.reset.track === "downtown" &&
  ...
  s.reset.butterflyPressed === "false",
