...
check(s.pageChrome && s.pageChrome.playing.active && s.pageChrome.playing.playing && s.pageChrome.playing.shown &&
  ...
  Math.abs(s.pageChrome.playing.videoVolume - s.pageChrome.mappedBefore) < .001 &&
  Math.abs(s.pageChrome.videoVolume - s.pageChrome.mappedAfter) < .001 &&
