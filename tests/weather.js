...
var HARNESS = [
  ...
  ' window.__loftControllers.phone.open("weather"); await sleep(250);',
  ...
  ' window.__setLang("cs"); await sleep(150); body=document.querySelector(".phone-app-body"); report.cs={names:texts(body,".wxc-name"),weekdays:texts(body,".wxc-weekday")};',
...
var HISTORICAL_HARNESS = [
  ...
  '  window.__loftControllers.phone.open("weather");await sleep(100);var body=document.querySelector(".phone-app-body");',
